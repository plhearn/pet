...
namespace RolePlayingGameData
{
    ...
    public abstract class FightingCharacter : Character
    {
        ...
        private void AddStandardCharacterCombatAnimations()
        {
            if (combatSprite != null)
            {
                combatSprite.AddAnimation(new Animation("Idle", 10, 10, 
                    CombatAnimationInterval, true));
                combatSprite.AddAnimation(new Animation("Walk", 9, 12,
                    CombatAnimationInterval, true));
                combatSprite.AddAnimation(new Animation("Attack", 9, 9, 
                    CombatAnimationInterval, false));
                combatSprite.AddAnimation(new Animation("SpellCast", 21, 22, 
                    CombatAnimationInterval, false));
                combatSprite.AddAnimation(new Animation("Defend", 9, 9, 
                    CombatAnimationInterval, false));
                combatSprite.AddAnimation(new Animation("Dodge", 9, 9, 
                    CombatAnimationInterval, false));
                combatSprite.AddAnimation(new Animation("Hit", 18, 18, 
                    CombatAnimationInterval, false));
                combatSprite.AddAnimation(new Animation("Die", 20, 20, 
                    CombatAnimationInterval, false));
            }
        }
