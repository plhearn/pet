                ...
                case CombatActionStage.Advancing:
                    {
                        ...
                        */
                        ...
                        if (Combatant.Position.X > Combatant.OriginalPosition.X - 100)
                        {
                            if(Combatant.Position.X > Target.Position.X)
                                advanceDirection = new Vector2(-100, 0);
                            else
                                advanceDirection = new Vector2(100, 0);
                        }
                        else
            ...
            get
            {
                switch (stage)
                {
                    ...
                    case CombatActionStage.Finishing: // ready to complete?
                        ...
                        if (combatant.GetType() == typeof(CombatantPlayer))
                        {
                            ((CombatantPlayer)combatant).AC = 0;
                        }

                        if (combatant.GetType() == typeof(CombatantMonster))
                        {
                            ((CombatantMonster)combatant).AC = 0;
                        }
