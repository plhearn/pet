...
namespace RolePlaying
{
    ...
    class CombatEngine
    {
        public Queue<Combatant> actionQueue = new Queue<Combatant>();     //queues up all the actions for the active battle system
        public Queue<CombatantPlayer> selectionQueue = new Queue<CombatantPlayer>();   //queues up the players who haven't picked an action yet
        public bool actionQueueLocked = false;
        public bool selectionQueueLocked = false;
        public Combatant currentCombatant;  //whoever is currently doing something
        public CombatantPlayer currentSelector;  //the player who currently has their action panel active
        ...
        /// </summary>
        private const int totalDelay = 300;
