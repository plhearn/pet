...
namespace RolePlaying
{
    ...
    class TextScreen : GameScreen
    {
        ...
        /// <summary>
        /// Construct a new TextScreen object.
        /// </summary>
        ...
        public TextScreen(int startPos, string dialogue)
        {
            this.IsPopup = true;
            ...
            dialogueStartPosition = new Vector2(startPos, 300f);
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                Fonts.DrawCenteredText(spriteBatch, Fonts.PlayerStatisticsFont, dialogueList[i], textPosition, Color.White);
